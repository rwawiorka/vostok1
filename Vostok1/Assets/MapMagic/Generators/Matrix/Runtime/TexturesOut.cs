...
namespace MapMagic.Nodes.MatrixGenerators {
	[System.Serializable]
	public class BaseTextureLayer : INormalizableLayer, IInlet<MatrixWorld>, IOutlet<MatrixWorld>, IOutput
	{
		...
		public BaseTextureLayer () { Opacity=1; }
	}
	...
	public abstract class BaseTexturesOutput<L> : Generator, IMultiInlet, IMultiOutlet, IOutputGenerator, IInvLayered<L> where L: BaseTextureLayer, new()
	{
		...
		public override void Generate (TileData data, StopToken stop) 
		{
			...
			{
				if (stop!=null && stop.stop) return;
				data.finalize.Add(FinalizeAction, layers[i], (MatrixWorld)data.products[layers[i]], data.currentBiomeMask);
			}
