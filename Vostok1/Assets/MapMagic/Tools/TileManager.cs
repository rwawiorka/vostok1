...
namespace Den.Tools
{
	...
	public class TileManager<T> : ISerializationCallbackReceiver where T: ITile//, IEquatable<T>
	{
		...
		protected T ConstructTile (object holder)
		{
		...
		#region Per-frame/Update
			...
			public void Update (Vector3 tileSize, object holder=null, bool distsOnly=false)
			{
				...
				bool camCoordsChanged = RefreshCamCoords(tileSize.x);
			...
			public void ReDeploy (Vector3 tileSize, object holder=null)
			{
				RemoveNulls(); //excluding removed objects
			...
			private bool RefreshCamCoords (float tileSize)
			/// Gets a list of camera (or tagged objects) positions. Uses a cached camPoses array. Returns true if camera positions changed.
			{
				...
				#endif
				{
					...
					if (camsLength == 0) { throw new Exception("TileManager: No Camera in scene to generate tiles."); }
		...
		#region Deploy
			...
			public virtual void Deploy (Coord[] camCoords, Dictionary<Coord,T> pinned=null, object holder=null)
	...
	{	
		...
		public void Pin (Coord coord, object holder=null)
		...
		public void Deploy (Coord[] camCoords, object holder=null)
