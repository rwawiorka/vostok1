...
namespace Den.Tools 
{
	...
	public struct Vector2D : IEquatable<Vector2D> 
	{
		...
		public static implicit operator Vector3(Vector2D v) => new Vector3(v.x, 0f, v.z);
		public static implicit operator Vector2D(Vector2 v) => new Vector2D(v.x, v.y);
		public static implicit operator Vector2(Vector2D v) => new Vector3(v.x, v.z);
		public static implicit operator Vector2D(float v) => new Vector2D(v, v);
