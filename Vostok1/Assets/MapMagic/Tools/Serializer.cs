...
namespace Den.Tools
{
	...
	public static class Serializer
	{
		...
		public struct Value
		{
			...
			[SerializeField][FieldOffset(2)] long v; //the only field serialized. Otherwise all values will be written

			[NonSerialized][FieldOffset(2)] bool boolVal;
			[NonSerialized][FieldOffset(2)] byte byteVal;
			[NonSerialized][FieldOffset(2)] sbyte sbyteVal;
			[NonSerialized][FieldOffset(2)] char charVal;
			[NonSerialized][FieldOffset(2)] decimal decimalVal;
			[NonSerialized][FieldOffset(2)] double doubleVal;
			[NonSerialized][FieldOffset(2)] float floatVal;
			[NonSerialized][FieldOffset(2)] int intVal;
			[NonSerialized][FieldOffset(2)] uint uintVal;
			[NonSerialized][FieldOffset(2)] long longVal; 
			[NonSerialized][FieldOffset(2)] ulong ulongVal;
			[NonSerialized][FieldOffset(2)] short shortVal;
			[NonSerialized][FieldOffset(2)] ushort ushortVal;

			[NonSerialized][FieldOffset(2)] int reference; //same as intVal
